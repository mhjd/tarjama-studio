...
1. Lancer l'executable courant depuis `desktop-releases/windows/`.
...
Note : l'executable n'est pas signe. Windows peut afficher un avertissement SmartScreen au premier lancement.
