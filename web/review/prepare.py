...
r['jobs']={name:dict(image=a.recorder_image,uid=10004,gid=10004,
    ...
    env=dict(REVIEW_DEVICE=a.device,REVIEW_VIDEO=a.video),
...
r.setdefault('configs',{})['ui-recording']={name:Path('web/review',name).read_text() for name in ('record.mjs','record-support.mjs','record-export.mjs')}
