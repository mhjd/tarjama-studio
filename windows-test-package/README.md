...
Fichiers fournis :
- `Tarjama-Studio-0.1.27-windows-portable.exe` : application Windows portable a lancer sur la machine de test.
...
1. Lancer `Tarjama-Studio-0.1.27-windows-portable.exe`.
...
5. Importer `traduction_fr.json`.
6. Tester la lecture, l'edition, puis les exports arabe et traduction.

Note : l'exe n'est pas signe. Windows peut afficher un avertissement SmartScreen au premier lancement.
